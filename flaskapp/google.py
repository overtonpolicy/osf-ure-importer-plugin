""" osfapp module for managing Google services 

Google Cloud Dashboard: https://console.cloud.google.com/apis/dashboard?project=uremethods&supportedpurview=project
Google Credentials are set up here: https://console.developers.google.com/apis/credentials

Callback urls are always /auth/googleauth-callback.html


Client Id 138772507523-00fai52l5a5irdg9femjv4gu067o3giq.apps.googleusercontent.com
client secret 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
GOOGLE_DISCOVERY_URL = (
    "https://accounts.google.com/.well-known/openid-configuration"
)

TODO:
Create https://uremethods.org/privacypolicy/
Create https://uremethods.org/termsofuse/
