...
""" 
This script hits the OSF API and caches information about URE Collection 
projects for use by other tools. 

We do this because having frontend apis hit the OSF API is too slow for what we
generally expect for responsiveness of web pages.
